  ...
  return (
    <div className='wrapper'>
      ...
      <Routes>
        ...
        <Route path="/dry-cleaning" element={<DryCleaningPage items={cartItems} setCartItems={setCartItems} />} />
        <Route path="/window" element={<WindowPage items={cartItems} setCartItems={setCartItems} />} />
